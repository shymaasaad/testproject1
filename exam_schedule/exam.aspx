<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="exam.aspx.cs" Inherits="exam_schedule.exam" %>
               ...
               <table id="content2" dir="rtl">
                ...
                <tr>
                    ...
                    <td class="auto-style19" colspan="4">
                                <asp:DropDownList ID="DropDownList_Group_Name1"  runat="server"  AppendDataBoundItems="true" DataSourceID="SqlDataSource_Groups"  DataTextField="Group_name" DataValueField="Group_id" >
...
<tr><td>
    ...
    <td class="auto-style2">
        <asp:Button ID="Button_insert_day" runat="server" Text="اضافة" Height="35px" Width="128px" OnClick="Button_insert_day_Click"   />
    </td>
</tr>
                   
    <tr><td>
        <strong>
        <asp:Label ID="Label_chose_day" runat="server" Text="بيانات الامتحانات" Font-Bold="true" Font-Size="X-Large" ForeColor="black" style="text-align: center"></asp:Label>
        </strong>
        </td></tr>
            ...
            <table dir="rtl" class="auto-style1">
                ...
                <tr>
                    ...
                    <tr>
                    <td class="auto-style3">
                        <asp:Label ID="Label_day" runat="server" Text="اليوم "></asp:Label>
                    </td>
                ...
                <tr>
                 ...
                 <tr>
                      ...
                      <td dir="rtl" class="auto-style42" colspan="9">
                        ...
                        <asp:Button ID="UncheckAll" runat="server" Text="Uncheck All" />
                                <asp:GridView ID="gridService_exam_Schedule" runat="server" Width="740px" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource_Schedule_Exam" ForeColor="#333333" GridLines="None" DataKeyNames="Schedule_Ex_id">
                 ...
                 <td class="auto-style11">
                      <asp:Button ID="button_save_exam" runat="server" Text="حفظ" Width="125px" Height="37px" OnClick="button_save_exam_Click" />
                             
                 </td>
                       <td class="auto-style11">
                      <asp:Button ID="button_delete_exam" runat="server" Text="حذف" Width="125px" Height="37px" OnClick="button_delete_exam_Click"  />
